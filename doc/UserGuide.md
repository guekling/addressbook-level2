...
### Finding all persons containing any keyword in their name or address: `find`
Finds persons whose names or addresses contain any of the given keywords.<br>
...
* `find Clementi`<br>
  Returns Any person having living in `Clementi`
